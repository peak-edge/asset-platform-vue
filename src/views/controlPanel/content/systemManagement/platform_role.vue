<template>
    <div class="platformrole-container">
        <el-card class="card1">
...
<style>
.platformrole-container .el-card {
	min-height: 89vh;
}
.platformrole-container .el-table .warning-row {
    background: oldlace;
}
.platformrole-container .el-table .success-row {
    background: #f0f9eb;
}
  /* 更改element-UI按钮样式 */
.platformrole-container .el-button--primary{
    color: #fff;
    background-color: rgb(14,122,162);
    border-color: rgb(14,122,162);
}
.platformrole-container .el-button--primary:hover{
    background-color: rgb(62,149,181);
    border-color: rgb(62,149,181);  
}
.platformrole-container .el-button--primary:focus{
    background-color: rgb(14,122,162);
    border-color: rgb(14,122,162);  
}
</style>
